...
const StatusCardTemp = ({ buttontext, makestate, makenum, nowstate, nownum, title, warning }) => {
  const { temperature, setTemperature } = useContext(GlobalContext); // 전역 변수 사용 예시
    ...
    <div className={styles.card}>
      ...
      <div className={styles.container}>
        ...
        <div className={styles['center-section']}>
          ...
          <div className={styles.number}>{temperature}</div> {/* 전역 상태 값 표시 */}
